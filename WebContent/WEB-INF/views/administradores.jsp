...
<div class="container">
	...
	<sf:form action="${pageContext.request.contextPath}/admin/guardar" method="post" commandName="admin">
		<table>
			<tr>
				<td></td>
			...
			<tr>
				<td></td>
				<td><sf:input class="form-control form-control-lg" placeholder="Cargo" path="cargo" type="text"/></td>
			</tr>
			<tr>
				<td></td>
